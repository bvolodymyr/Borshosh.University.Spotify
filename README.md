...
Sign Up (Optional): If you're a new user, click on "Sign Up" and create an account with a username and password. This will allow you to save your playlists and preferences. You can skip this step for now and explore the app as a guest.
...
Browse through the various music categories on the left-hand menu (these categories might be limited in the initial version).
Playing Music:
...
Uploading music (if logged in):

Click on the "Upload music" button.
Give your song a name, add a mp3 file and the cover and click "Create."
...
Database:
Stores user data, music metadata, and other app data.
...
- Define project tasks decomposition for project documentation ✔️
